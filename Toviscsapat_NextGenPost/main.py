...
# # wait(1000000)
# LFOL(color1, color2, 70, 30, 0.7, 3)
# wait(1500)
# print(gyro.angle())
# AbsTU(225, 100, gyro)
# print(gyro.angle())
...
# wait(1000)
# AbsTU(180, 100, gyro)
# MedMotor(100, 25, "A", [1, 2])
# AbsDRV(180, 100, 20, gyro)
# MedMotor(-100, 20, "A", [1, 2])
# AbsDRV(180, -100, -50, gyro)
# AbsTU(90, 100, gyro)
...
while True:
    ...
    if Button.CENTER in ev3.buttons.pressed() and not isRunning:
        ...
        # isRunning = False
        curRound += 1
    elif Button.LEFT in ev3.buttons.pressed() and not isRunning: #curRound == 1 and 
        # if __name__=="__main__":
        # p.join()
        Text.close()
        print("bal gomb")
